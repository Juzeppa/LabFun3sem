...
int main()
{
	...
	while (1)
	{
		...
		printf("\nPlease, choose what to do: (1)-to search, (2)-to add person, (3)-to delete person, (4)-to uploade list to a file, (5)-to print list, (6)-to exit\n");
		scanf("%d", &key);

		switch (key)
		{
			case 1:
				printf("Enter surname, name and secondname to add person to list\n");
